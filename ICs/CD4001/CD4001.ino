...
void loop() {
  ...
  digitalWrite(input2, HIGH);
  delay (500);
  writeMessage("LED1: OFF = Input1: Low & Input2: High");
  digitalWrite(input1, LOW);
  digitalWrite(input2, HIGH);
  delay(500);
  writeMessage("LED1: OFF = Input1: High & Input2: Low");
  digitalWrite(input1, HIGH);
  ...
  digitalWrite(input4, HIGH);
  delay (500);
  writeMessage("LED2: OFF = Input3: Low & Input4: High");
  digitalWrite(input3, LOW);
  digitalWrite(input4, HIGH);
  delay(500);
  writeMessage("LED2: OFF = Input3: High & Input4: Low");
  digitalWrite(input3, HIGH);
  ...
  digitalWrite(input6, HIGH);
  delay (500);
  writeMessage("LED3: OFF = Input5: Low & Input6: High");
  digitalWrite(input5, LOW);
  digitalWrite(input6, HIGH);
  delay(500);
  writeMessage("LED3: OFF = Input5: High & Input6: Low");
  digitalWrite(input5, HIGH);
  ...
  digitalWrite(input8, HIGH);
  delay (500);
  writeMessage("LED4: OFF = Input7: Low & Input8: High");
  digitalWrite(input7, LOW);
  digitalWrite(input8, HIGH);
  delay(500);
  writeMessage("LED4: OFF = Input7: High & Input8: Low");
  digitalWrite(input7, HIGH);
